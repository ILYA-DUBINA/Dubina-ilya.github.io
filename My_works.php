            ...
            <div class="myworks__content">
               <div class="myworks__content-sits">
                  <div class="sits__image border-right">
                     <a href="http://first-restaurant.space/#sidebar"><picture><source srcset="images/my_works/1-1).webp" type="image/webp"><img class="sits__image-img" src="images/my_works/1-1)" alt="картинка сайта моей верстки"></picture></a>
                  </div>
                  ...
                  <div class="sits__image border-bottom">
                     <a href="http://dubina-ilya.site/My_worksAll.php"><picture><source srcset="images/my_works/4-2).webp" type="image/webp"><img class="sits__image-img" src="images/my_works/4-2).png" alt="картинка сайта всех моих работ"></picture></a>
                  </div>
               </div>
               ...
               <div class="myworks__content-comments">       
                  ...
                  <?php 
                     ...
                     $maxId = mysqli_fetch_array($id_q, MYSQLI_NUM);
                        ...
                        echo '<a href="My_works_all_comments.php">Показать все комментарии('; 
                        echo $maxId[0]; 
                        echo ')</a>'; 
                  ?>   
                        ...
                        <div class="comments__user-text">
                           ...
                           <div class="text__links">                       
                              ...
                              <?php if($row['idUser'] == $_SERVER['REMOTE_ADDR']){?>
                                 <div class="text__links-div">
                                    <a class="text__link-two" href="php/update.php?id=<?php echo $row['id']; ?>">Изменить</a> &nbsp;                               
                                    <a class="text__link-three" href="php/delete.php?id=<?php echo $row['id']; ?>">Удалить</a>
                                 </div>                       
                              <?php }?>
                           </div>
                        </div>
                        ...
                        <div class="comments__user-text">
                           ...
                           <p class="text__text"><?php echo $resTwo['message']?></p>                                   
                              <?php if($resTwo['idUser'] == $_SERVER['REMOTE_ADDR']){?>
                                 <div class="text__links-div"> 
                                    <a class="text__link-two" href="php/update.php?id=<?php echo $resTwo['id']?>">Изменить</a> &nbsp;                               
                                    <a class="text__link-three" href="php/delete.php?id=<?php echo $resTwo['id']?>">Удалить</a>  
                                 </div> 
                              <?php }?>                           
                        </div>                      
                     </div>
